...
from Infrastructure.configuration.dependency import  get_consumo_repository, get_spotify_service, get_user_repository
...
def get_consultar_artista_service(spotify_service: AbstractSpotifyService = Depends(get_spotify_service), consumo_repository: ConsumoRepository = Depends(get_consumo_repository)) -> ConsultarArtistaService:
    return ConsultarArtistaServiceImpl(spotify_service=spotify_service, consumo_repository=consumo_repository)